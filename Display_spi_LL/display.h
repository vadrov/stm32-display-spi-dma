...
#define LCD_STATIC_WORK_BUFFER_SIZE	750	//Используется при статическом выделении памяти для пересылки данных из буфера на дисплей,
										//т.е. данные для отправки можно формировать в одной из половин этого буфера.
										//Размер этого буфера должен быть равен удвоенному размеру
										//планируемого максимального блока данных, пересылаемых на дисплей.
#endif
/* --------------------------------------------------------------------------------------------------------------------- */
